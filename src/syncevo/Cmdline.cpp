...
public:
    CmdlineTest() :
        ...
        m_scheduleWorldConfig("peers/scheduleworld/.internal.ini:# HashCode = 0\n"
                              ...
                              "peers/scheduleworld/config.ini:# autoSyncInterval = 30\n"
                              "peers/scheduleworld/config.ini:# autoSyncDelay = 15\n"
...
private:
    ...
    string OldScheduleWorldConfig() {
        ...
        string oldConfig =
            ...
            "spds/syncml/config.txt:# autoSyncInterval = 30\n"
            "spds/syncml/config.txt:# autoSyncDelay = 15\n"
